...
const History = () => {
  ...
  const nextPageHandler = e => {
    e.preventDefault();
    if (query.page >= historyData.pages) return;
    setQuery({ ...query, page: query.page + 1 });
  };
          ...
          <TableRow>
            <TableCell colSpan={3}>
              <div className="flex flex-row w-full justify-between space-x-4">
                <div>Total : {historyData?.total || 0}</div>
                <div className="flex-grow">Pages: {historyData?.pages || 1}</div>
            ...
            <TableCell colSpan={2}>
              <Pagination className="justify-end *:hover:cursor-pointer">
                <PaginationContent>
                  ...
                  <PaginationItem onClick={e => pageHandler(historyData.pages)}>
                    <SkipForward />
                  </PaginationItem>
                </PaginationContent>
              </Pagination>
